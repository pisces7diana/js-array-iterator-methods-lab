...
console.log('Exercise 1 Diana Results:' , veryOldInventors)
...
console.log('Exercise 2 Diana results:' , inventorNames)
...
console.log('Exercise 3 Diana Result:' , sortedByBirthYear)
...
console.log('Exercise 4 Diana Result: ', inventorNamedAda)
...
console.log('Exercise 5 Diana Result: ', firstLast)
...
console.log('Exercise 6 Diana Result: ',isAdultPresent)
...
console.log('Exercise 7 Diana Result: ', isEveryone19OrOlder)
...
console.log('Exercise 8 Diana Result: ' , commentById)
...
console.log('Exercise 9 Diana Result: ' , idx)
